...
/obj/bullet_act(obj/projectile/P)
	...
	if(!QDELETED(src)) //Bullet on_hit effect might have already destroyed this object
		take_damage(P.damage * (demolition_factor ? (P.demolition_mod + demolition_factor - 1) / demolition_factor : 1), P.damage_type, P.armor_flag, 0, turn(P.dir, 180), P.armour_penetration)
