...
/obj/mecha/working/clarke
	...
	max_integrity = 300
	integrity_failure = 150 // i apologize for my abuse of this mech (i will do it again)
	step_in = 2
	...
	armor = list(MELEE = 35, BULLET = 10, LASER = 20, ENERGY = 0, BOMB = 60, BIO = 0, RAD = 100, FIRE = 100, ACID = 100)
	max_equip = 7
	enter_delay = 40
	pivot_step = TRUE
